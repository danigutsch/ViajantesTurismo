...
{
    public async Task<GetBookingDto[]> GetAllBookings(CancellationToken cancellationToken = default)
    {
    ...
    public async Task<GetBookingDto?> GetBookingById(long id, CancellationToken cancellationToken = default)
    {
        return await httpClient.GetFromJsonAsync<GetBookingDto>($"/bookings/{id}", cancellationToken);
    }

    public async Task<GetBookingDto[]> GetBookingsByTourId(int tourId, CancellationToken cancellationToken = default)
    {
        List<GetBookingDto>? bookings = null;
    ...
    public async Task<GetBookingDto[]> GetBookingsByCustomerId(int customerId, CancellationToken cancellationToken = default)
    {
        List<GetBookingDto>? bookings = null;
    ...
    public async Task<Uri> CreateBooking(CreateBookingDto dto, CancellationToken cancellationToken = default)
    {
    ...
    public async Task UpdateBooking(long id, UpdateBookingDto dto, CancellationToken cancellationToken = default)
    {
    ...
    public async Task ConfirmBooking(long id, CancellationToken cancellationToken = default)
    {
        var response = await httpClient.PatchAsync(new Uri($"/bookings/{id}/confirm", UriKind.Relative), null, cancellationToken);
        response.EnsureSuccessStatusCode();
    }

    public async Task CompleteBooking(long id, CancellationToken cancellationToken = default)
    {
        var response = await httpClient.PatchAsync(new Uri($"/bookings/{id}/complete", UriKind.Relative), null, cancellationToken);
        response.EnsureSuccessStatusCode();
    }

    public async Task DeleteBooking(long id, CancellationToken cancellationToken = default)
    {
