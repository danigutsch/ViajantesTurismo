...
/// <summary>
/// Defines domain-owned validation limits for Admin aggregates and value objects.
/// </summary>
public static class AdminDomainLimits
{
    ...
    /// <summary>
    /// The maximum length for medical information fields.
    /// </summary>
    ...
    /// <summary>
    /// The minimum weight value in kilograms for physical information.
    /// </summary>
    public const int MinWeightKg = 1;

    /// <summary>
    /// The maximum weight value in kilograms for physical information.
    /// </summary>
    public const int MaxWeightKg = 500;

    /// <summary>
    /// The minimum height value in centimeters for physical information.
    /// </summary>
    public const int MinHeightCm = 50;

    /// <summary>
    /// The maximum height value in centimeters for physical information.
    /// </summary>
    public const int MaxHeightCm = 300;

    /// <summary>
    /// The maximum percentage value for discount.
    /// </summary>
