...
--------|----------|----------|--------------------
SKMSG001 | SharedKernel.Messaging | Error | Registered integration-event consumer has no concrete handler
SKMSG002 | SharedKernel.Messaging | Error | Registered integration-event consumer has multiple concrete handlers
