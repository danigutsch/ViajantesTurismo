...
/// <summary>
/// Validates package metadata required for SharedKernel package publication.
/// </summary>
public static class PackageMetadataValidator
{
    /// <summary>
    /// Validates central and project package metadata under a repository root.
    /// </summary>
    /// <param name="repositoryRoot">The repository root.</param>
    /// <exception cref="ArgumentException">Thrown when required repository paths are missing.</exception>
    /// <exception cref="InvalidOperationException">Thrown when required metadata is missing.</exception>
    ...
    {
        if (ProjectPropertyReader.Read(project, propertyName) is null)
        {
    ...
    private static bool IsNonPackable(string project) => string.Equals(ProjectPropertyReader.Read(project, "IsPackable"), "false", StringComparison.OrdinalIgnoreCase);
}
