...
internal sealed class IntegrationEventOutboxMessageConfiguration : IEntityTypeConfiguration<IntegrationEventOutboxMessage>
{
    ...
    public IntegrationEventOutboxMessageConfiguration()
        : this(SharedKernelSchemas.Messaging, IntegrationEventStorageOptions.DefaultOutboxTableName)
    {
    }

    public IntegrationEventOutboxMessageConfiguration(string schema, string tableName)
    {
    ...
    public void Configure(EntityTypeBuilder<IntegrationEventOutboxMessage> builder)
    {
        ...
        builder.Property(message => message.ClaimedBy).HasMaxLength(IntegrationEventOutboxMessage.ClaimOwnerMaxLength);
