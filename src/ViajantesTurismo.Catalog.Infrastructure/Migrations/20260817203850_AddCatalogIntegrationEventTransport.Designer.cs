...
namespace ViajantesTurismo.Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20260817203850_AddCatalogIntegrationEventTransport")]
    partial class AddCatalogIntegrationEventTransport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SharedKernel.Messaging.IntegrationEvents.EntityFrameworkCore.IntegrationEventTransportMessage", b =>
                {
                    ...
                    b.ToTable("transport_messages", "messaging");
                });
            ...
            modelBuilder.Entity("ViajantesTurismo.Catalog.Infrastructure.CatalogTourReadModelEntity", b =>
                {
                    ...
                    b.Property<long>("PresentationPosition")
                        .IsConcurrencyToken()
                        .HasColumnType("bigint");

                    b.Property<long>("PublicationPosition")
                        .IsConcurrencyToken()
                        .HasColumnType("bigint");
