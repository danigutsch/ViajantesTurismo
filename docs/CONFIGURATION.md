...
| `Authentication:TokenExchange:Provider` | None; required `Keycloak` | Exact value `Keycloak` | Yes | `ViajantesTurismo.Management.Web` | Selects the current Keycloak RFC 8693 audience-token exchange implementation. |
