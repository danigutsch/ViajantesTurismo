...
Developers use the Aspire dashboard for local trace and metric inspection. Operators and dashboard
authors should consume only the stable names and dimensions documented in the telemetry contract.

## Dashboard authoring rules

- Start from operational questions, not available tags.
- Use low-cardinality dimensions: service, bounded context, operation, provider, and outcome.
