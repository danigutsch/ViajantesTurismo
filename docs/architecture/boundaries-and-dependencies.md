...
flowchart TB
    ...
    SharedKernel_EntityFrameworkCore[SharedKernel.EntityFrameworkCore] --> SharedKernel_Idempotency[SharedKernel.Idempotency]
    SharedKernel_EntityFrameworkCore[SharedKernel.EntityFrameworkCore] --> SharedKernel_IntegrationEvents[SharedKernel.IntegrationEvents]
