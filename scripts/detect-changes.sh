...
fast_validation_patterns=(
    ...
    "src/SharedKernel/SharedKernel.IntegrationEvents/**"
    "src/SharedKernel/SharedKernel.IntegrationEvents.CloudEvents/**"
    ...
    "tests/SharedKernel.IntegrationEvents.Tests/**"
    "tests/SharedKernel.IntegrationEvents.CloudEvents.Tests/**"
