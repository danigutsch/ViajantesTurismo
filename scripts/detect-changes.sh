...
fast_validation_patterns=(
    ...
    "src/SharedKernel/SharedKernel.Domain.EntityFrameworkCore/**"
    "src/SharedKernel/SharedKernel.AuditTrail/**"
    "src/SharedKernel/SharedKernel.AuditTrail.SourceGenerator/**"
    ...
    "src/SharedKernel/SharedKernel.Idempotency.EntityFrameworkCore/**"
    "src/SharedKernel/SharedKernel.ImageProcessing/**"
    "src/SharedKernel/SharedKernel.Messaging/**"
    "src/SharedKernel/SharedKernel.Messaging.IntegrationEvents/**"
    ...
    "src/SharedKernel/SharedKernel.Mediator.EntityFrameworkCore/**"
    "src/SharedKernel/SharedKernel.Aspire.Analyzers/**"
    ...
    "tests/SharedKernel.Messaging.IntegrationEvents.CloudEvents.Tests/**"
    "tests/SharedKernel.Messaging.IntegrationEvents.GeneratorTests/**"
    "tests/SharedKernel.Messaging.Tests/**"
    "tests/SharedKernel.HttpClients.Tests/**"
    ...
    "tests/SharedKernel.RepoConfig.Tests/**"
    ...
    "tests/ViajantesTurismo.Catalog.ApiServiceTests/**"
    "tests/ViajantesTurismo.Catalog.BehaviorTests/**"
    "tests/ViajantesTurismo.Catalog.InfrastructureTests/**"
    "tests/ViajantesTurismo.Catalog.UnitTests/**"
    "tests/ViajantesTurismo.DatabaseObservability.Tests/**"
...
admin_integration_patterns=(
    ...
    "tests/SharedKernel.Npgsql.Tests/**"
...
if ! changed_files="$(git diff --no-renames --name-only "${diff_range}")"; then
