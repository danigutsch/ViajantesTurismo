...
configs=(
    ...
    "tests/SharedKernel.Messaging.IntegrationEvents.Tests/stryker-config.json"
    "tests/SharedKernel.Messaging.IntegrationEvents.CloudEvents.Tests/stryker-config.json"
