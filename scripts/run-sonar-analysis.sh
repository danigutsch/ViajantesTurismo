...
sonar_coverage_exclusions="benchmarks/**,samples/**,scripts/**,tests/performance/**,tools/ViajantesTurismo.Performance.Tool/**,src/ViajantesTurismo.AppHost/**,src/SharedKernel/SharedKernel.Mediator.SourceGenerator/IsExternalInit.cs"
sonar_cpd_exclusions="benchmarks/**,tests/performance/**,tools/ViajantesTurismo.Performance.Tool/**"
