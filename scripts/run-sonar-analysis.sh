...
sonar_coverage_exclusions="benchmarks/**,samples/**,scripts/**,tests/performance/**,src/ViajantesTurismo.AppHost/**,src/SharedKernel/SharedKernel.Mediator.SourceGenerator/IsExternalInit.cs"
sonar_cpd_exclusions="benchmarks/**"
