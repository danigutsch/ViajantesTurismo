...
sonar_coverage_exclusions="benchmarks/**,samples/**,scripts/**,tests/performance/**,src/SharedKernel/SharedKernel.Mediator.SourceGenerator/IsExternalInit.cs,src/ViajantesTurismo.Catalog.ApiService/Program.cs"
