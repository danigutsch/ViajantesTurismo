...
{
    internal sealed record Payload(Node? Node, Repository? Repository, AddProjectItemResult? AddProjectV2ItemById);
    internal sealed record Node(string? Id, int? Number, Owner? Owner, ProjectItemConnection? Items);
