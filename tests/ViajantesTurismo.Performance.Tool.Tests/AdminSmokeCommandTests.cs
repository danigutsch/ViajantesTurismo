...
public sealed class AdminSmokeCommandTests
{
    ...
    {
        // Arrange
        using var allowExternalScope = new EnvironmentVariableScope("VT_K6_ALLOW_EXTERNAL", "0");
    ...
    [Fact]
    public void Allows_external_admin_api_targets_when_explicitly_enabled()
    {
        // Arrange
        using var allowExternalScope = new EnvironmentVariableScope("VT_K6_ALLOW_EXTERNAL", "1");
        const string target = "https://example.com";
    ...
    [Fact]
    public void Rejects_admin_api_targets_without_http_scheme()
    {
        // Arrange
        const string target = "ftp://localhost";
        ...
        exception.Message.ShouldBe("VT_API_BASE_URL must start with http:// or https://.");
    }
    ...
    public void Allows_http_debug_when_explicitly_enabled()
    {
        ...
        // Act
        var exception = Record.Exception(() => AdminSmokeCommand.ValidateK6Arguments(k6Arguments));
    ...
    [Theory]
    [InlineData("-e", "VT_API_BASE_URL=http://evil.example")]
    [InlineData("--env", "VT_K6_DURATION=1s")]
    ...
    public void Allows_results_directories_under_performance_results(string resultsDirectory, string expected)
    {
        ...
        // Act
        var normalized = AdminSmokeCommand.NormalizeResultsDirectory(input);
    ...
    public void Rejects_rooted_results_directories(string resultsDirectory)
    {
        ...
        // Act
        Action act = () => AdminSmokeCommand.NormalizeResultsDirectory(input);
    ...
    public void Allows_safe_profile_names(string profile)
    {
        ...
        // Act
        var exception = Record.Exception(() => AdminSmokeCommand.ValidateProfile(value));
    ...
    public void Rejects_unsafe_profile_names(string profile)
    {
        ...
        // Act
        Action act = () => AdminSmokeCommand.ValidateProfile(value);
    ...
    public void Allows_explicit_docker_mode_values(string useDocker)
    {
        ...
        // Act
        var resolved = AdminSmokeCommand.ResolveUseDocker(value);
    ...
    public void Rejects_implicit_docker_mode_values(string useDocker)
    {
        ...
        // Act
        Action act = () => AdminSmokeCommand.ResolveUseDocker(value);
    ...
    public void Allows_unpinned_docker_image_when_docker_mode_is_disabled()
    {
        ...
        // Act
        var exception = Record.Exception(() => AdminSmokeCommand.ValidateDockerImage(dockerImage, "0"));
    ...
    public void Allows_digest_pinned_docker_image_when_docker_mode_is_enabled()
    {
        ...
        // Act
        var exception = Record.Exception(() => AdminSmokeCommand.ValidateDockerImage(dockerImage, "1"));
