...
public sealed class BookingCustomerEntitySteps(BookingCustomerContext context)
{
        ...
        decimal bikePrice)
    {
        ...
        context.Result = BookingCustomer.Create(Guid.CreateVersion7(), type, bikePrice);
    }
    ...
    {
        context.Result = BookingCustomer.Create(Guid.CreateVersion7(), BikeType.Regular, bikePrice);
    }
    ...
    {
        var type = Enum.Parse<BikeType>(bikeType);
        context.Result = BookingCustomer.Create(Guid.CreateVersion7(), type, 0m);
    }
    ...
    {
        context.Result = BookingCustomer.Create(Guid.CreateVersion7(), (BikeType)invalidBikeType, 50m);
    }
