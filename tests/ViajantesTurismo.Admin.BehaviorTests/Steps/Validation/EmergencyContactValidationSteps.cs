...
public sealed class EmergencyContactValidationSteps(CustomerContext context)
{
    ...
    {
        global::SharedKernel.Testing.Assertions.TestAssert.True(context.EmergencyContactResult.IsSuccess, context.EmergencyContactResult.ErrorDetails?.Detail ?? "Creation failed");
        global::SharedKernel.Testing.Assertions.TestAssert.NotNull(context.EmergencyContactResult.Value);
    }
    ...
    {
        global::SharedKernel.Testing.Assertions.TestAssert.True(context.EmergencyContactResult.IsFailure, "Expected failure but got success");
        ...
        global::SharedKernel.Testing.Assertions.TestAssert.Contains("Emergency contact name is required.", allErrors);
    }
    ...
    public void ThenIShouldBeInformedThatEmergencyContactNameCannotExceed128Characters()
    {
        ...
        var errors = context.EmergencyContactResult.ErrorDetails?.ValidationErrors;
        var allErrors = errors?.Values.SelectMany(e => e).ToList() ?? new List<string>();
        global::SharedKernel.Testing.Assertions.TestAssert.Contains("Emergency contact name cannot exceed 128 characters.", allErrors);
    }
    ...
    public void ThenIShouldBeInformedThatEmergencyContactMobileIsRequired()
    {
        ...
        var errors = context.EmergencyContactResult.ErrorDetails?.ValidationErrors;
        var allErrors = errors?.Values.SelectMany(e => e).ToList() ?? new List<string>();
        global::SharedKernel.Testing.Assertions.TestAssert.Contains("Emergency contact mobile is required.", allErrors);
    }
    ...
    public void ThenIShouldBeInformedThatEmergencyContactMobileCannotExceed64Characters()
    {
        ...
        var errors = context.EmergencyContactResult.ErrorDetails?.ValidationErrors;
        var allErrors = errors?.Values.SelectMany(e => e).ToList() ?? new List<string>();
        global::SharedKernel.Testing.Assertions.TestAssert.Contains("Emergency contact mobile cannot exceed 64 characters.", allErrors);
    }
    ...
    {
        global::SharedKernel.Testing.Assertions.TestAssert.Equal("Jane Doe", context.EmergencyContactResult.Value.Name);
        global::SharedKernel.Testing.Assertions.TestAssert.Equal("+1234 567890", context.EmergencyContactResult.Value.Mobile);
    }
}
