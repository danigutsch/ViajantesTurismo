...
- Negative discounts are not allowed
    ...
    early bird specials, or negotiated rates.
        ...
        @error_case
        Scenario: Discount reason is too short
            When I create a booking with principal customer 1, regular bike, single room, 15% discount, and reason "Short"
            Then I should not be able to create the booking
            And I should be informed that the discount reason is too short

        @error_case
        Scenario: Discount reason is too long
            When I create a booking with principal customer 1, regular bike, single room, 15% discount, and a very long reason
            Then I should not be able to create the booking
            And I should be informed that the discount reason is too long
