@BC:Admin @Agg:Customer @VO:MedicalInfo @regression
...
Rule: Allergies field must not exceed maximum length when provided
    ...
    @Invariant:INV-CUST-030 @error_case @critical
    ...
    @Invariant:INV-CUST-030 @happy_path
...
Rule: Multiple validation errors are reported together
    ...
    @Invariant:INV-CUST-030 @error_case
