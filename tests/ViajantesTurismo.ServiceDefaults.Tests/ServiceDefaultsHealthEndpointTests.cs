...
public sealed class ServiceDefaultsHealthEndpointTests
{
    ...
    [Fact]
    public async Task Map_default_endpoints_exposes_production_safe_unhealthy_response()
    {
        // Arrange
        var builder = WebApplication.CreateBuilder(new WebApplicationOptions
        {
        ...
        builder.Services.AddHealthChecks()
            .AddCheck("dependency", () => HealthCheckResult.Unhealthy("sensitive dependency detail"));
