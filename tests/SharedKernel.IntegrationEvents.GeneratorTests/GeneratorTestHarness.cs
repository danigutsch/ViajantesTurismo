...
using SharedKernel.IntegrationEvents.SourceGenerator;
using SharedKernel.Testing.Roslyn;

namespace SharedKernel.IntegrationEvents.GeneratorTests;

internal static class GeneratorTestHarness
{
    public const string GeneratedHintName = "SharedKernel.IntegrationEvents.GeneratedIntegrationEventMappings.g.cs";
    ...
    public static CSharpCompilation CreateCompilation(string source)
    {
        ...
        return CSharpCompilation.Create(
            assemblyName: "SharedKernel.IntegrationEvents.Tests.Dynamic",
