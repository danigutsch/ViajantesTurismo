...
public sealed class CatalogContractValidationTests
{
    ...
    private static CatalogTourDto CreateTour()
    {
    ...
    private static List<ValidationResult> Validate<T>(T value)
    {
