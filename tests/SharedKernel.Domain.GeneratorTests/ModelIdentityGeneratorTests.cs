...
public sealed class ModelIdentityGeneratorTests
{
    ...
    public void Generates_identity_equality_for_opted_in_identified_partial_class()
    {
        ...
        (generatedSource).ShouldContain("namespace Demo;", StringComparison.Ordinal);
        (generatedSource).ShouldContain("public partial class Customer", StringComparison.Ordinal);
        (generatedSource).ShouldContain("public override bool Equals(object? obj)", StringComparison.Ordinal);
        (generatedSource).ShouldContain("obj is not Customer other", StringComparison.Ordinal);
        (generatedSource).ShouldContain("GetType() != other.GetType()", StringComparison.Ordinal);
        (generatedSource).ShouldContain(".Default.Equals(Id, default!)", StringComparison.Ordinal);
        (generatedSource).ShouldContain("public override int GetHashCode()", StringComparison.Ordinal);
    }
    ...
    public void Reports_diagnostic_when_type_is_not_partial()
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL001");
    ...
    public void Reports_diagnostic_when_id_property_is_missing()
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL003");
    }
    ...
    public void Reports_diagnostic_when_id_type_does_not_match_identified_interface()
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL004");
    }
    ...
    public void Reports_diagnostic_when_model_inherits_from_a_base_class()
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL005");
    }
    ...
    public void Generates_distinct_sources_for_same_type_name_in_different_namespaces()
    {
        ...
        // Assert
        (runResult.Diagnostics).ShouldBeEmpty();
        (generatedSources).ShouldContain(source => string.Equals(source.HintName, "First.Customer.ModelSupport.g.cs", StringComparison.Ordinal));
        (generatedSources).ShouldContain(source => string.Equals(source.HintName, "Second.Customer.ModelSupport.g.cs", StringComparison.Ordinal));
    }
    ...
    public void Reports_diagnostic_when_model_is_nested()
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL006");
    }
    ...
    public void Reports_diagnostic_when_id_shape_is_not_stable(string idProperty)
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL007");
    }
    ...
    public void Reports_diagnostic_when_model_is_record_class()
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL008");
    }
    ...
    public void Reports_diagnostic_when_model_is_generic()
    {
        ...
        // Assert
        (diagnostic.Id).ShouldBe("SKMDL009");
    }
}
